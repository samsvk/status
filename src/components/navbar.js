export default function Navbar() {
  return (
    <div className="flex flex-row items-center w-full gap-10 py-5 mt-12">
      ...
      <div className="w-full h-[1px] max-w-screen-md bg-spotify-text/20"></div>
      <nav className="w-max">
      ...
      <div className="w-full h-[1px] max-w-sm bg-spotify-text/20"></div>
