    ...
    <>
      ...
      <div className="flex w-full max-w-6xl gap-10 mx-auto my-10">
        <div className="flex-1 p-10 border-2 rounded-lg border-spotify-text bg-spotify-bg">
          <div className="grid items-start justify-start grid-cols-6 gap-10 text-spotify-text w-max">
            {userData?.playlists?.map((playlist, index) => (
              <div
                key={playlist.id}
                className="relative flex-1 w-max"
              >
                <div className="flex flex-row items-center">
                  <div className="flex">
                    ...
                    <div className="flex flex-col items-start justify-end ml-2">
                      <h3 className="text-left text-[14px] font-normal  tracking-tight first-letter:uppercase whitespace-nowrap">
                        {playlist.name}
                      </h3>
