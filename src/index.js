  ...
  return (
    <div className="max-w-[1200px] w-full mx-auto px-6 flex items-center justify-center flex-col">
      ...
      <p className="text-[18px] text-center leading-7 font-normal tracking-tight text-neutral-700/60 my-8 max-w-[660px] w-full">
        For the last time ever enter your email - gain access to
      ...
      >
        <input
          className="flex-1 px-4 pt-1 pb-1.5 flex items-center bg-transparent min-h-[35px] focus:outline-none focus:outline-offset-0 hover:outline-none hover:outline-offset-0 placeholder:text-base placeholder:text-[14px] placeholder:font-medium placeholder:tracking-tight placeholder:text-left placeholder:text-black/80 text-base text-[14px] font-medium tracking-tight text-left text-black/80 "
          type="text"
      ...
      <div>
        <p className="text-center mx-auto text-[14px] flex-1 mt-12 leading-5 font-normal text-neutral-700/80 my-10 tracking-tight flex gap-1 items-center">
          ...
          now only{" "}
          <span className="font-medium text-black/80">$15</span>
          for unlimited masks.
        </p>
      </div>
    </div>
